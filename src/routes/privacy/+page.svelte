...
<main class="mt-4 w-full max-w-3xl px-5 sm:mt-10">
	...
	<p class="mb-5 text-lg sm:text-xl">
		This website is hosted on Vercel, which generates logs that may include the date and time of your request, the
		requested resource, and your anonymized IP address. For more information, please refer to
		<Link href="https://vercel.com/legal/privacy-policy">Vercel's privacy policy</Link>.
	</p>

	<p class="mb-5 text-lg sm:text-xl">
		If you sign up for our waitlist using your email address, we use Supabase to securely store and manage your data.
		For more details, you can review
		<Link href="https://supabase.com/privacy">Supabase's privacy policy</Link>. If you subscribed to Kani's waitlist and
		would like us to delete your data, please contact us using the email addresses below.
	</p>
